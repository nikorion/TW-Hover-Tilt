/*\
title: $:/plugins/nikorion/hover-tilt/modules/lang.js
 ...
 *
 * Resolves translated strings for the <$HoverTilt> widget.
 *
 ...
 *   $:/plugins/nikorion/hover-tilt/language/<lang-code>/<key>
 *
 * For example:
 *   $:/plugins/nikorion/hover-tilt/language/fr-FR/Errors/LibraryMissing
 *
 * Fallback chain:
 ...
 *
 * The wikitext-side equivalent of this same fallback chain is the
 * `hover-tilt-lingo` procedure in language/lingo.tid — keep both in sync if
 * the language base path ever changes.
 *
 * Exported:
...
(function () {
  ...
  var LANG_BASE = "$:/plugins/nikorion/hover-tilt/language/";
